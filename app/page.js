...
export default function Home() {
  return (
    <>
    <div className="flex justify-center  flex-col items-center h-[50vh] text-white">
    <div className="font-bold text-3xl flex gap-5 m-2 items-center">Buy me a Galaxy! <img width={55} className="invert mix-blend-screen		" src="/images/nebula.gif" alt="" /></div>
